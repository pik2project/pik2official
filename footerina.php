...
<footer > 
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-4 col-sm-12 leftpart garis">
            <h4 >Terhubung dengan Kami</h4>
            <hr style="width:55%; border:1px solid; color:#caa461; margin-bottom:10px; margin-top:8px;">
          ...
          <div class="col-md-4 col-sm-12 rightpart">
            ...
            <hr style="width:20%; border:1px solid; color:#caa461; margin:auto; margin-bottom:10px;">
            <ul>
      ...
      <div class="copyright text-center">
        ...
        <p style="font-size:13px;">Di design dan dikembangkan oleh Billy Wijaya G, Leon Chrisdion, Winston Renatan</p>
      </div>
    </footer>
